...
full_results_df.to_csv("/data/scRNA/ABCA/AIBS/AWS/expression_matrices/WMB-10Xv3/20230630/outputs/WMB-10Xv3-Isocortex-1-raw-sc-wgcna-ME-sc-fullTau.csv")
...
common_results_df.to_csv("/data/scRNA/ABCA/AIBS/AWS/expression_matrices/WMB-10Xv3/20230630/outputs/WMB-10Xv3-Isocortex-1-raw-sc-wgcna-ME-sc-commonTau.csv")

merged_df = pd.merge(full_results_df, common_results_df, on="module", suffixes=("_full", "_common"))
